...
setFalshData('userDetail', $userDetail);
...
if (isPost()){
    ...
    if (empty($errors)){
        ...
        if ($updateStatus){
            setFalshData('msg', 'Đổi mật khẩu thành công. Bạn có thể đăng nhập bằng mật khẩu mới ngay bây giờ.');
            ...
            setFalshData('msg', 'Hệ thống đang gặp sự cố! Vui lòng thử lại sau.');
